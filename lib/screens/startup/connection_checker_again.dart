...
class NetworkCheckerAgain extends StatefulWidget {
  @override
  _NetworkCheckerAgainState createState() => _NetworkCheckerAgainState();
}

class _NetworkCheckerAgainState extends State<NetworkCheckerAgain> {
  ...
  connectionListener(Event event) {
    ...
    if (event.snapshot.value) {
      ...
      print("Not Connected");
      router.navigateTo(context, '/check-connection', transition: TransitionType.fadeIn, clearStack: true);
    }
  }
